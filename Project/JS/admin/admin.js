...
document.getElementsByClassName("same")[1].style.backgroundColor="antiquewhite"
document.getElementsByClassName("same")[1].style.color="brown"

checkNumberAlert()
// checkLoginAdmin(currentUser)
// function checkLoginAdmin(currentUser) {
...
function updateProduct(id){
    ...
    document.getElementById("viewUpdate").style.width="30vw"
    for(let i=0;i<renderArr.length;i++){
        if(renderArr[i].id==id){
    ...
    <div style="display: flex;flex-direction: column; padding: 1vw 7vw;">
        ...
        <button style="padding:0.2vw;border-radius:0.5vw;font-size:1vw;" onclick="updateNewProduct(${i})">Cập nhập</button>
        </div>
