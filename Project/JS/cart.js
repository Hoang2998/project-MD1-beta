...
function pay(){
    ...
    for (let i = 0; i < listUser.length; i++) {
        if(listUser[i].id == currentUser){
            document.getElementById("inputUserCart").value = listUser[i].username
        } 
    }
...
function checkPhoneNumber(){
    phoneNumber = document.getElementById("inputPhoneNumber").value.match(/(0[3|5|7|8|9])+([0-9]{8})\b/g)
...
function payTotal(){
    if( document.getElementById("inputUserCart").value && document.getElementById("inputAddressCart").value  && document.getElementById("inputPhoneNumber").value ){
    ...
    if(checkPhoneNumber() == true){
        ...
        document.getElementsByClassName("alertPayAccept")[0].innerHTML = 
        `
        <div>
        ...
        document.getElementsByClassName("alertPayAccept")[0].classList.add("alert")
        document.getElementsByClassName("alertPayAccept")[0].innerHTML = "Số điện thoại không đúng định dạng"
        setTimeout(()=>{
            document.getElementsByClassName("alertPayAccept")[0].classList.remove("alert")
        },1500)
    }
        ...
        document.getElementsByClassName("alertPayAccept")[0].classList.add("alert")
        document.getElementsByClassName("alertPayAccept")[0].innerHTML = "Bạn chưa điền đủ thông tin"
        setTimeout(()=>{
            document.getElementsByClassName("alertPayAccept")[0].classList.remove("alert")
        },1500)
    }
